	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal" method="POST" action="cargo_add.php">
					...
					<div class="form-group">
						<label for="rate" class="col-sm-3 control-label">Monto</label>
...
<div class="modal fade" id="edit">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal" method="POST" action="cargo_edit.php">
					...
					<div class="form-group">
						<label for="edit_rate" class="col-sm-3 control-label">Monto</label>
...
<div class="modal fade" id="delete">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal" method="POST" action="cargo_del.php">
